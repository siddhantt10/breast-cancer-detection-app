...
const Contact = () => {
  return (
    <div className="text-white bg-[url('/pattern.svg')] bg-cover bg-opacity-60 flex flex-col h-screen">
      <Navbar />
      <section className="pt-24" id="contact animate-fadeInSlide">
          ...
          <div className="mb-4">
            <div className="mb-6 max-w-3xl">
              ...
              <p className="mx-auto max-w-3xl text-xl text-gray-600 dark:text-slate-400">
                With our team, Group 179
              </p>
            </div>
          </div>
          <div className='border-t-4 border-dashed border-gray-600 my-8'></div>
          <div className="flex items-stretch justify-center">
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                <p className="mb-8 text-sm text-gray-600 dark:text-slate-400">
                  We are a team of developers and designers who are passionate about creating a better future
                  with the help of technology. We are always looking for new opportunities to work with.
                </p>
                <ul className="mb-6 md:mb-0">
                  <li className="flex">
                    ...
                    <div className="ml-4 mb-4">
                      ...
                      <p className="text-gray-600 dark:text-slate-400">VIT Bhopal Univercity</p>
                      <p className="text-gray-600 dark:text-slate-400">Kothri, Sehore(M.P)</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                    ...
                    <div className="ml-4 mb-4">
                      ...
                      <p className="text-gray-600 dark:text-slate-400">Mobile: +91 79876 94152</p>
                      <p className="text-gray-600 dark:text-slate-400">Mail: siddpatel1010@gmail.com</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
